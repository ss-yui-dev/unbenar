...
NDiplomacy = {
	...
	GREAT_PROJECT_WARSCORE_COST_MODIFIER = 0.05,	-- love
	...
	HRE_FOREIGN_CONTROL_PENALTY = -0.01,			-- love
	HRE_HERETIC_PENALTY = -0.03,					-- love
	LACK_OF_ELECTORS_HIT = -0.1,					-- Also applied to vassalized electors
	JOIN_HRE_DEVELOPMENT_CAP_VASSAL = 100,			-- love
	...
	JUSTIFY_TRADE_CONFLICT_LIMIT = 0.02,					-- love
	JUSTIFY_TRADE_CONFLICT_ACTOR_LIMIT = 0.01,				-- love
	...
	COUNTERESPIONAGE_DISCOVER_CHANCE = 0.50,			-- love
	COUNTERESPIONAGE_NETWORK_IMPACT = -0.33,			-- love
	BUILD_SPY_DISCOVERED_PENALTY = -10.0,
	BUILD_SPY_NETWORK_SPEED = 1.5,
	SPY_NETWORK_DECAY = 1,
	SPY_NETWORK_SIEGE_EFFECT = 0.5,						-- love
	SPY_NETWORK_AE_EFFECT = -0.3,
	SPY_NETWORK_TECH_EFFECT = -0.1,						-- love
	...
	JUSTIFY_TRADE_CONFLICT_COST = 2,					-- love
	INFILTRATE_ADMINISTRATION_COST = 85,				-- love
	SABOTAGE_REPUTATION_COST = 60,
	STEAL_MAPS_COST = 50,
	SUPPORT_REBELS_COST = 40,							-- love
	SOW_DISCONTENT_COST = 80,
	AGITATE_FOR_LIBERTY_COST = 90,
	SABOTAGE_RECRUITMENT_COST = 80,
	SLANDER_MERCHANTS_COST = 70,
	CORRUPT_OFFICIALS_COST = 50,						-- love
	INFILTRATE_ADMINISTRATION_DURATION = 36,			-- love
	...
	AE_SAME_RELIGION = 0.3,				--love
	AE_SAME_RELIGION_GROUP = 0.0,
	AE_DIFFERENT_RELIGION = -0.3,		--love
	AE_HRE_INTERNAL = 0.5,
	...
	PO_RETURN_CORES_AE = 0.5, 					-- love
	PO_FORM_PU_AE = 0.125, 							-- love
	PO_CONCEDE_COLONIAL_AE = 0.2,
	PO_BECOME_VASSAL_AE = 0.5, 					-- _DDEF_PO_BECOME_VASSAL_AE = 10, (Per development)
	PO_FORCE_JOIN_EMPIRE_AE = 0.35, 					--love
	PO_TRANSFER_VASSAL_AE = 0.35,					--love
	...
	PEACE_COST_PILLAGE_CAPITAL = 101,					-- love
	...
	DIPLOMAT_SPEED = 5.0,							-- love
	DIPLOMAT_COOLDOWN_TIME = 0,						-- love
	MIN_RELATIONS_TO_ALLY = 25,						-- love
	...
	ELECTIVE_VICTORY_LEGITIMACY = 15,				-- love
	...
	SPY_DISCOVERY_COOLDOWN_MONTHS = 24,				-- love
	...
	KNOWLEDGE_SHARING_COST_PERCENT_MONTHLY = 20.0,		-- love
...
NCountry = {
	...
	GOLDEN_ERA_YEARS = 50,
	SPLENDOR_ABILITY_COST = 1000,					-- love
	...
	MERCHANT_REPUBLIC_SIZE_LIMIT = 9999,			-- love
	MONARCH_MIN_SKILL = 1,						-- love
	MONARCH_MAX_SKILL = 9,						-- love
	ELECTIVE_LOCAL_MONARCH_MIN_BONUS = 1,		-- love
	...
	ABDICATE_LEGITIMACY_HIT = -40,				-- love
	ABDICATE_PRESTIGE_HIT = -75,				-- love


	DISINHERIT_PRESTIGE_HIT = -75,				-- love
	...
	NEW_HEIR_LEGITIMACY_HIT = -50,				-- love
	...
	STATE_MAINTENANCE_DEV_FACTOR = 0.015,		-- love
	STATE_MAINTENANCE_DISTANCE_FACTOR = 0.001,	-- distance
	STATE_MAINTENANCE_CONTINENT_FACTOR = 0.3,	-- love
	STATE_MAINTENANCE_CULTURE_FACTOR = 0.3,		-- love

	ALLOW_ZERO_BASE_VALUES = 0,						-- Affects base tax, base manpower, and base production

	COUNTRY_DEVELOPMENT_SCALE = 40000,			-- love
	NOMAD_DEVELOPMENT_SCALE = 1000,				-- love
	...
	ESTATE_LOYALTY_DECAY_BASE_MIN = 6.0,		-- love
	ESTATE_LOYALTY_DECAY_BASE_MAX = 9.0,		-- love
	...
	ESTATE_MIN_DISTRIBUTED_CROWNLAND = 33.0, 	-- love
	...
	MAX_IDEA_GROUPS_FROM_SAME_CATEGORY = 0.35,		-- love
	...
	MAX_ACTIVE_POLICIES = 15,						-- love
	MINIMUM_POLICY_TIME = 15,						-- love
	POLICY_COST = 2,								-- love
	BASE_POSSIBLE_POLICIES = 5,						-- love
	...
	LAND_FORCELIMIT_EXTRA_COST_FACTOR = 4,			-- love
	NAVAL_FORCELIMIT_EXTRA_COST_FACTOR = 4,			-- love
	...
	ADVISOR_COST_INCREASE_PER_YEAR = 0.015,			-- love
	SCRIPTED_ADVISOR_DISCOUNT = 0.75,				-- love
	...
	MAXIMUM_ADVISOR_SKILL = 10,						-- love
	PROMOTE_COST_MONTHS_ADVISOR_SALARY = 90.0,		-- love
	...
	IDEA_TO_TECH = -0.003,			-- love
	TECH_TIME_COST = 2.5,			-- love
	TECH_AHEAD_OF_TIME = 0.15,		-- per year ahead.


	PS_BUY_IDEA = 300,				-- love
	PS_BUY_NATIVE_ADVANCEMENT = 500,
	PS_BUY_RELIGIOUS_REFORM = 0,
	PS_ADVANCE_TECH = 400,			--love
	...
	PS_IMPROVE_PROVINCE_BASE = 80,	-- love
	...
	ABANDON_IDEAGROUP_REFUND = 0,					-- love
	...
	MAX_EXTRA_PERSONALITIES = 4,					-- love
	FIRST_EXTRA_PERSONALITY = 0,					-- love
	...
	REVOLT_SIZE_DEVELOPMENT_MULTIPLIER = 0.1,		-- love
	REVOLT_SIZE_BASE = 2,							-- love
	REVOLT_TECH_IMPACT = 0.05, 						-- love
	REVOLT_TECH_MORALE = 0.05,						-- love
	...
	LIBERTY_DESIRE_RELATIVE_POWER = 45,				-- love
	...
	SCUTAGE_TAX_FRACTION = 0.17,	--love
	...
	DEBT_LIMIT_ADM = -999,							-- love
	DEBT_LIMIT_DIP = -999,							-- love
	DEBT_LIMIT_MIL = -999,							-- love
	MAX_FERVOR = 100.0,
	...
	INNOVATIVENESS_DAYS_AFTER_FIRST_PICK_VIABLE = 30, -- love
	INNOVATIVENESS_MAX = 400.0, -- love
...
NEconomy = {
	EDICTS_COST_INCREASE = 1.0,					-- love
	EDICTS_DURATION_MONTHS = 3,					-- love
	...
	CARAVAN_FACTOR = 25.0,							-- love
	CARAVAN_POWER_MAX = 25,							-- love
	CARAVAN_POWER_MIN = 2,
	MAX_BUILDING_SLOTS = 18,						-- love
...
NMilitary = {
	...
	REVANCHISM_DEVASTATION_IMPACT = -0.12,			-- love
	...
	BASE_MP_TO_MANPOWER = 0.075,					-- love
	SIEGE_ATTRITION = 1,
	...
	GALLEY_DICE_MALLUS_HIGH_SEA = -1.0,				-- love
	...
	HEAVY_SHIP_SAILORS_COST = 250,					-- love
	LIGHT_SHIP_SAILORS_COST = 70,					-- love
	GALLEY_SHIP_SAILORS_COST = 150,					-- love
	TRANSPORT_SHIP_SAILORS_COST = 50,				-- 1 = 1 men in cost.
	MAX_MANPOWER = 10, 								-- years in mp pool
	MIN_MONTHLY_MANPOWER = 0.01,					-- love
	...
	ARTILLERY_SPEED = 0.6, 							-- love

	INFANTRY_COST = 10.0, 							-- _MDEF_INFANTRY_COST = 10,
	CAVALRY_COST = 50.0, 							-- love
	ARTILLERY_COST = 60.0, 							-- love
	FORTRESS_COST = 1.0,							-- love
	HEAVY_SHIP_COST = 300, 							-- love
	LIGHT_SHIP_COST = 50, 							-- love
	GALLEY_COST = 50, 								-- love
	TRANSPORT_COST = 12,							-- _MDEF_TRANSPORT_COST = 10,
	INFANTRY_TIME = 120, 							-- love
	CAVALRY_TIME = 150, 							-- love
	ARTILLERY_TIME = 180, 							-- love
	HEAVY_SHIP_TIME = 730, 							-- _MDEF_HEAVY_SHIP_TIME = 10,
	LIGHT_SHIP_TIME = 200, 							-- love
	GALLEY_TIME = 365, 								-- _MDEF_GALLEY_TIME = 10,
	TRANSPORT_TIME = 150, 							-- love
	MONTHLY_REINFORCE = 0.2,						-- love
	MONTHLY_REPAIR = 0.19,							-- love
	EXTRA_LAND_REINFORCE_COST = 1.00,				-- love
	MERCENARY_REINFORCE_COST_MULTIPLIER = -0.5,		-- love
	...
	WAR_LENGTH_DAMAGE_MODIFIER = 0.10,				-- love
	...
	DELIBERATE_RETREAT_MORALE_PENALTY = 0,			-- love
	...
	EXPLORATION_TRAVEL_TIME = 5,					-- love
	...
	CANNOT_RETREAT_DAYS = 6, 						-- love
	DAYS_PER_PHASE = 1,								-- love
	DAYS_PER_SIEGE_PHASE = 20,						-- love
	SLACKEN_MANPOWER_INCREASE = 0.5, 				-- love
	...
	REBEL_RELOCATION_TIME = 1.0,					-- love
	REBEL_RELOCATION_DISTANCE_MAX = 400,			-- love
	LEADER_MAX_PIPS = 10,							-- love
	LEADER_MIN_PIPS = 1,								-- Min general/admiral pips (total)
	REBEL_LEADER_POWER = 50,						-- love
	REBEL_GARRISON_GROWTH = 2,							-- Rebel garrison growth is multiplied by this value
	RIVER_CROSSING_PENALTY = 2,					-- love
	STRAIT_CROSSING_PENALTY = 4,					-- love
	SEA_LANDING_PENALTY = 4,						-- love
	...
	MIN_RECRUIT_TIME_MODIFIER = 0.5,				-- love
	...
	MAX_REBEL_SUPPRESSION = 10.0;				-- love
	INF_SUPPRESSION = 0.25,						-- The amount of reduction to unrest for each friendly infantry regiment in a province
	CAV_SUPPRESSION = 0.50,						-- love
	ART_SUPPRESSION = 0.1,						-- love

	FORT_FLIPPING_TIME = 60,					-- love
	...
	LIGHT_SHIP_COMBAT_WIDTH = 1.5,					-- love
	GALLEY_COMBAT_WIDTH = 1,
	TRANSPORT_COMBAT_WIDTH = 1,
	NAVAL_CASUALTY_MIN_MORALE_DAMAGE = 0.2,
	CAPTURED_SHIP_STRENGTH = 0.1,					-- love
	CAPTURED_SHIP_MORALE = 0.1,						-- love
	NAVAL_MISSION_REGION_MIN_PROVINCES_IN_RANGE = 20,	--love
	...
	SUPPLY_DEPOT_MIL_COST = 5,						-- love
	MARINE_SHOCK_DAMAGE_TAKEN = -0.50,				-- love
	MARINE_DISEMBARK_SPEED_BONUS = 5.0,				-- love
	...
	NAVAL_DOCTRINE_MIN_FORCE_LIMIT = 50,			-- love
	...
	MERCENARY_COMPANY_HIRING_COST_MONTHS = 36,		-- love
	MERCENARY_COMPANY_STARTING_MORALE = 0.5,		-- Starting morale
	MERCENARY_COMPANY_MIN_REGIMENTS = 4,			-- Minimum regiments
	MERCENARY_COMPANY_MAX_REGIMENTS = 80,			-- love
	MERCENARY_COMPANY_MANPOWER_PER_REGIMENT = 1.0,	-- love
	...
	MERCENARY_COMPANY_BUILDING_TIME = 1.5,			-- love
	...
	MERCENARY_COMPANY_ARMY_TRADITION = 20.0,		-- love
...
NAI = {
	...
	GREAT_PROJECT_DESIRE_MOVE_FROM_SUBJECT_MODIFIER = 3.5,		--love
	GREAT_PROJECT_DESIRE_LEAVE_IN_SUBJECT_MODIFIER = 0.5,
	GREAT_PROJECT_DESIRE_UPGRADE_IN_SUBJECT_MODIFIER = 0.5,
	GREAT_PROJECT_DESIRE_UPGRADE_MODIFIER = 5.5,		--love
	GREAT_PROJECT_DESIRE_BUILD_NEW_MODIFIER = 5,		--love
	GREAT_PROJECT_DESIRE_CAPITAL_MODIFIER = 5,			--love
	GREAT_PROJECT_DESIRE_CAPITAL_BASE = 100,			--love
	GREAT_PROJECT_DESIRE_CAPITAL_AREA_MODIFIER = 5,		--love
	ACCEPTABLE_BALANCE_DEFAULT = 0.6, 					--love
	ACCEPTABLE_BALANCE_MULT_FRIEND_IN_COMBAT = 0.3,		--love
	ACCEPTABLE_BALANCE_MULT_OFFENSIVE = 0.50, 			--love
	ACCEPTABLE_BALANCE_THREAT_WEIGHT = 0.6,				--love
	...
	EDICT_VALUE_THRESHOLD = 9, 						-- love
	EDICT_VALUE_THRESHOLD_MULTIPLY_DEFICIT = 6, 	-- love
	...
	WANT_TRIBUTARY_LOST_MANDATE = 20, -- love
	NOMINAL_ARMY_SIZE_MULTIPLIER = 1.15, -- love
	MIN_CAV_PERCENTAGE = 9.0, 	-- love
	MAX_CAV_PERCENTAGE = 60, 	-- love
	...
	DIPLOMATIC_ACTION_GUARANTEE_POWERBALANCE_FACTOR = 30, --love
	DIPLOMATIC_ACTION_GIFT_POWERBALANCE_FACTOR_AI = 35, --love
	DIPLOMATIC_ACTION_GIFT_POWERBALANCE_FACTOR_PLAYER = 30, --love
	DIPLOMATIC_ACTION_SUBSIDIES_POWERBALANCE_FACTOR = 30, --love
	...
	DIPLOMATIC_ACTION_OFFER_CONDOTTIERI_ONLY_MILITARY_RULERS = 0, --love
	...
	DIPLOMATIC_ACTION_OFFER_CONDOTTIERI_DISABLE_VERSUS_PLAYER_ENEMIES = 1, --love
	...
	DIPLOMATIC_ACTION_TAKE_ON_DEBT_ALLY_FACTOR = 50, --love
	...
	DIPLOMATIC_ACTION_INFLUENCE_NATION_BASE_FACTOR = 5, --love
	DIPLOMATIC_ACTION_INFLUENCE_NATION_ALLY_FACTOR = 20, --love
	...
	AI_FORT_PER_DEV_RATIO = 36, 	-- love
	FORT_ON_BORDER_MULT = 1.79, 	-- love 
	FORT_NEXT_TO_FORT_MULT = 0.01,	-- love 
	...
	FORT_CAPITAL_DESIRE = 1000.0, -- love
	...
	PS_SHORT_TERM_POOL = 185, 				-- love
	AI_WANT_ACCEPT_CULTURES = 1000.0,	 	-- love
	AGGRESSIVENESS = 625, 					-- love
	AGGRESSIVENESS_BONUS_EASY_WAR = 825, 	-- love
	MISSION_PICK_CHANCE = 10000, 			-- love
	TRADE_INTEREST_THRESHOLD = 3, -- Number of merchants required to be a nation with trade interest
	DEFICIT_SPENDING_MIN_MONTHS = 3, 		-- love
	DEFICIT_SPENDING_MIN_MONTHS_PEACETIME = 100, -- love
	BIGSHIP_FRACTION = 0.25,	-- love
	ARTILLERY_FRACTION = 0.20, 	-- love
	FORCE_COMPOSITION_CHANGE_TECH_LEVEL = 16, -- love
	TRANSPORT_FRACTION = 0.45, -- love
	INCOME_SAVINGS_FRACTION = 0.3, -- love
	OVER_FORCELIMIT_AVOIDANCE_FACTOR = 60, -- love
	MILITARISE_FORT_BUDGET_FACTOR = 1.5, --if the country should militarise, multiply fort budget priority by this
	DESIRED_SURPLUS = 0.13, -- love
	DESIRED_DEFICIT = 0.1, -- love
	EXTRA_SURPLUS_WHEN_NEEDING_BUILDINGS = 0.25, -- love
	MAX_SAVINGS = 425, -- love
	BUDGET_STEAL_THRESHOLD = 10.0, -- AI will move budget from one area to another if its priority is this many times as high.
	ADVISOR_BUDGET_FRACTION_MAX = 0.5, -- love
	ADVISOR_BUDGET_FRACTION_MIN = 0.2, -- love
	ADVISOR_BUDGET_FRACTION_MERITOCRACY_MAX = 0.5, -- If the AI has meritocracy enabled
	ADVISOR_BUDGET_FRACTION_MERITOCRACY_MIN = 0.2, -- love
	...
	DIPLOMATIC_INTEREST_DISTANCE = 176, -- love
	CONQUEST_INTEREST_DISTANCE = 101, -- love
	...
	MAX_BUILDING_COST_INCOME_MONTHS = 50, -- love
	PURSUE_DISTANCE = 95, -- love
	...
	REVOLUTION_EMBRACE_MAX_ABSOLUTISM = 40, -- love
	BASE_CAN_MAKE_CORE_DESIRE_TO_RETURN_PROVINCE = 15, --love
	...
	GOVERNING_CAPACITY_OVER_PERCENTAGE_TOLERATED = 0.4,		-- love
	GOVERNING_CAPACITY_REFORM_PROGRESS_GAP_TOLERANCE = 50,
	GOVERNING_CAPACITY_REFORM_BIAS_IF_NEEDED = 100,
	DANGEROUS_OVEREXTENSION_PERCENTAGE = 1.1,				-- love

	DEBASE_THRESHOLD = 700,			-- love

	DEVELOPMENT_CAP_BASE = 30,		-- love
	DEVELOPMENT_CAP_MULT = 1.36,	-- love
	...
	PEACE_DESPERATION_FACTOR = 35, -- love
	...
	PEACE_DESIRE_AI_PREFS_QUICK_PEACE = 55, -- love
	PEACE_CALL_FOR_PEACE_FACTOR = 100,	-- love
	PEACE_MANDATE_THREAT_FACTOR = 0.5,  -- Modifies how much AI wants peace based on threat to celestial empire mandate.

	PEACE_TERMS_BASE_SCORE = 20, 		-- love
	PEACE_RANDOM_FACTOR = 0.0, 			-- love
	PEACE_TERMS_CB_MULT = 1.5, 			-- love
	PEACE_TERMS_STRATEGY_MULT = 0.75, 	-- love
	PEACE_TERMS_MIN_SCORE = 0.8, 		-- love
	...
	PEACE_TERMS_ANNEX_BASE_MULT = 300.0,	--love
	PEACE_TERMS_PILLAGE_CAPITAL_MULT = 0.0,	--love
	PEACE_TERMS_PROVINCE_BASE_MULT = 20.0,	--love
	...
	PEACE_TERMS_RELEASE_VASSALS_BASE_MULT = 0.9,	--love
	PEACE_TERMS_TRANSFER_VASSALS_BASE_MULT = 0.9,	--love
	PEACE_TERMS_RELEASE_ANNEXED_BASE_MULT = 0.75,
	PEACE_TERMS_ANNUL_TREATIES_BASE_MULT = 0.0,		--love
	PEACE_TERMS_GOLD_BASE_MULT = 0.245,				--love
	PEACE_TERMS_GIVE_UP_CLAIM = 0.0,
	PEACE_TERMS_GIVE_UP_CLAIM_PERMANENT = 0.0,		--love
	...
	PEACE_TERMS_TRIBUTARY_BASE_MULT = 8.5, -- love
	...
	PEACE_TERMS_PROVINCE_NO_CB_MULT = 0.85, -- love
	PEACE_TERMS_PROVINCE_CORE_MULT = 3.5, -- love
	PEACE_TERMS_PROVINCE_WARGOAL_MULT = 5.0, -- love
	PEACE_TERMS_PROVINCE_CLAIM_MULT = 2.5, -- love
	PEACE_TERMS_PROVINCE_NOT_CULTURE_MULT = 0.9, -- love
	PEACE_TERMS_PROVINCE_VASSAL_MULT = 1.0, -- love
	PEACE_TERMS_PROVINCE_REAL_ADJACENT_MULT = 3.5, -- love
	PEACE_TERMS_PROVINCE_NOT_ADJACENT_MULT = 0.05, -- love
	PEACE_TERMS_PROVINCE_NO_INTEREST_MULT = 0.01, -- love
	PEACE_TERMS_PROVINCE_OVEREXTENSION_MIN_MULT = 1.0, -- love
	PEACE_TERMS_PROVINCE_OVEREXTENSION_MAX_MULT = 7.0, -- love
	PEACE_TERMS_PROVINCE_ISOLATED_CAPITAL_MULT = 1.01, -- love
	...
	PEACE_TERMS_RETURN_CORES_VASSAL_MULT = 20.0, -- love
	...
	PEACE_TERMS_MIN_MONTHS_OF_GOLD = 10, -- love
	...
	PEACE_TERMS_TRANSFER_VASSAL_MAX_MULT = 0.5, -- love
	...
	PEACE_TERMS_WAR_REPARATIONS_BASE_MULT = 0.02, -- love
	PEACE_TERMS_WAR_REPARATIONS_MIN_INCOME_RATIO = 0.8, -- love
	...
	DIPLOMATIC_ACTION_PERSONALITY_MULT = 2.25, -- love

	CONVERT_TRIBUTARY_TO_VASSAL_AI_DESIRE_BASE = 40,	--love
	CONVERT_TRIBUTARY_TO_VASSAL_AI_DESIRE_PREPARING_FOR_WAR_SCORE = 100,	--love
	CONVERT_TRIBUTARY_TO_VASSAL_AI_DESIRE_WANTS_LAND_SCORE = 50,	--love
	...
	DIPLOMATIC_ACTION_ALLIANCE_ACCEPTANCE_MULT = 2.25, -- love
	...
	DIPLOMATIC_ACTION_IMPROVE_RELATIONS_BEFRIEND_FACTOR = 190, -- love
	DIPLOMATIC_ACTION_IMPROVE_RELATIONS_ALLY_FACTOR = 190, -- love
	...
	DIPLOMATIC_ACTION_IMPROVE_RELATIONS_VASSALIZE_FACTOR = 200, -- love
	...
	DIPLOMATIC_ACTION_MILITARY_ACCESS_EXISTING_RELATION_MULT = 20.0, -- love
	DIPLOMATIC_ACTION_MILITARY_ACCESS_ENEMY_REGIMENTS_FACTOR = 2.5, -- love
 	DIPLOMATIC_ACTION_VASSALIZE_DEVELOPMENT_FACTOR = 100, -- love
	...
	DIPLOMATIC_ACTION_WARNING_WARN_FACTOR = 60, -- love
	...
	DIPLOMATIC_ACTION_FABRICATE_CLAIM_BASE_FACTOR = 1000, -- love
	DIPLOMATIC_ACTION_FABRICATE_CLAIM_STRATEGY_FACTOR = 2.0, -- love
	DIPLOMATIC_ACTION_FABRICATE_CLAIM_OTHER_CB_FACTOR = 1.5, -- love
	...
	DIPLOMATIC_ACTION_CORRUPT_OFFICIALS_RIVAL_FACTOR = 50, -- love
	...
	DIPLOMATIC_ACTION_SUBSIDIES_WAR_WITH_RIVAL_FACTOR = 25, -- love
	...
	DIPLOMATIC_ACTION_SUBSIDIES_INDEBTED_FACTOR = 40, -- love
	...
	AI_TOTAL_DEV_CULTURE_MULTIPLIER = 13,				-- love
	...
	DIPLOMATIC_ACTION_TRIBUTARY_EMPIRE_FACTOR = 19.5,			-- love
	...
	FOREIGN_MINISTER_IGNORE_DISTANCE_BASE = 7,				-- love
	...
	INVADING_BRAVERY = 1.2,									-- love
	INVADING_MAX_AWAY_RATIO = 0.4,							-- love
	...
	DRILLING_BUDGET_OF_SURPLUS = 0.75,							-- love
	...
	DANGEROUS_ESTATE_INFLUENCE_BUFFER = 6.0,					-- love
	ADVISOR_MIN_SKILL_RELUCTANT_FIRE = 3,						-- AI will be reuluctant to fire advisors with skill above this (due to prior investment)
	ADVISOR_PROMOTION_AGE_CUTOFF = 61,							-- love
	FIRE_ADVISOR_LOAN_REQUIREMENT = 5,							-- AI will not fire advisors until it has this many loans
	MIN_FORCE_LIMIT_SHARE_REGION_ASSIGN = 0.20,					-- love
	MAX_ARMIES_NEW_REGION_ASSIGN_ALGORITHM = 40,				-- love
	MAX_TASKS_NEW_REGION_ASSIGN_ALGORITHM = 50,					-- love
	...
	ASSIMILATION_INTEREST_AMOUNT_FACTOR = 1000,					-- love
	INVASION_ARMY_LOOKUP_INTERVAL_ON_FAILURE = 12,				-- love
	...
	WAR_MIN_WARSCORE_TO_JOIN = -5,								-- love
	ARMY_DISTANCE_SCORE_IMPACT = 0.5,							-- Army <-> province distance impact on province evaluation
	BORDER_DISTANCE_SCORE_IMPACT = 12.0,						-- love
	IMPORANT_PROVINCE_THRESHOLD = 0.02,							-- love
	REGION_PLANNING_HOMELAND_PRIORIZATION = 25.0,				-- love
	...
	UPGRADE_CENTER_OF_TRADE_BASE_AI_DESIRE = 500.0,				-- love
	...
	RECRUIT_ADVISOR_BASE_AI_DESIRE = 80.0,						-- love
	PROMOTE_ADVISOR_BASE_AI_DESIRE = 50.0,						-- love
	DEFENDER_OF_FAITH_BASE_AI_DESIRE = 2.245,					-- love
	CALL_ECUMENICAL_COUNCIL_BASE_AI_DESIRE = 0.0,				-- AI scoring for calling ecumenical council, multiplied by budget/cost
	REPAY_LOAN_BASE_AI_DESIRE = 10000,							-- love
	...
	ESTATE_MAX_WANTED_INFLUENCE = 94.0,							-- love
	ESTATE_MIN_WANTED_CROWNLAND = 20.0,							-- love
	ESTATE_MAX_PRIVILEGES = 10, 								-- love
...
NAIEconomy = {
	BUDGETING_ADJUSTMENT_STEP = 0.11,						-- love
	REBEL_THREAT_MILITARIZE_THRESHOLD = 1.0,				-- love
	MILITARY_FOCUS_DEFAULT = 2.85,							-- love
	MILITARY_FOCUS_LOWER_BOUND = 3.0,						-- love
	MILITARY_FOCUS_UPPER_BOUND = 4.5,						-- love
	ARMY_FRACTION_MILITARIZE = 2.2,							-- love
	ARMY_FRACTION_PEACEFUL = 2.1,							-- love
	ARMY_FRACTION_MILITARIST = 4.35,						-- love
	NAVY_FRACTION_PEACEFUL = 2.0,							-- love
	NAVY_FRACTION_CAPITALIST = 2.0,							-- love
	FORT_FRACTION_MILITARIZE = 4.0,							-- love
	FORT_FRACTION_MILITARIST = 7.0,							-- love
	FORT_FRACTION_CAPITALIST = 6.0,							-- love
	MISSIONARY_FRACTION = 0.175,							-- love
	STATE_MAINTENANCE_FRACTION = 2,							-- love
	BASE_SAVINGS_PRIORITY = 0.5,
	BASE_SAVINGS_PRIORITY_WARTIME = 0.0,
	LOAN_REPAYMENT_SAVINGS_PRIORITY = 10000,				-- love
...
NReligion = {
	...
	MAX_CHRISTIAN_RELIGIOUS_CENTERS = 4,						-- love
...
NGovernment = {
	...
	GOVERNMENT_REFORM_COST_INCREASE = 50.0,					-- love
	...
	GOVERNMENT_REFORM_COST_CENTRALIZE_STATE = 25.0,			-- love
